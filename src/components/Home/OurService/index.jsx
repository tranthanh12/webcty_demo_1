                        ...
                        <div className={style.service_item}>
                            ...
                            <div className={style.item_c}>
                                <div className={style.item}>
                                    ...
                                    <div className={style.link_service}>
                                        <p href="">Web Development Services</p>
                                        <img className={style.img_shear} src="./images/ourService/arrow-up-right.svg" alt="" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className={style.item_c}>
                                <div className={style.item}>
                                    ...
                                    <div className={style.link_service}>
                                        <p href="">Open Source & CMS Customization and Implementations</p>
                                        <img className={style.img_shear} src="./images/ourService/arrow-up-right.svg" alt="" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className={style.item_c}>
                                <div className={style.item}>
                                    ...
                                    <div className={style.link_service}>
                                        <p href="">Mobile Application Development</p>
                                        <img className={style.img_shear} src="./images/ourService/arrow-up-right.svg" alt="" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className={style.item_c}>
                                <div className={style.item}>
                                    ...
                                    <div className={style.link_service}>
                                        <p href="">Custom Enterprise Solutions</p>
                                        <img className={style.img_shear} src="./images/ourService/arrow-up-right.svg" alt="" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className={style.item_c}>
                                <div className={style.item}>
                                    ...
                                    <div className={style.link_service}>
                                        <p href="">Technology Integration Services</p>
                                        <img className={style.img_shear} src="./images/ourService/arrow-up-right.svg" alt="" />
                                    </div>
                                </div>
                            </div>
